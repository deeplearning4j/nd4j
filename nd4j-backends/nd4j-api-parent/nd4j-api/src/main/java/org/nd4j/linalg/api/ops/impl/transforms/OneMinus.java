...
public class OneMinus extends BaseTransformOp {
    public OneMinus(SameDiff sameDiff, DifferentialFunction i_v, boolean inPlace) {
        super(sameDiff, i_v, inPlace);
    }

    public OneMinus(SameDiff sameDiff, DifferentialFunction i_v, int[] shape, boolean inPlace, Object[] extraArgs) {
        super(sameDiff, i_v, shape, inPlace, extraArgs);
    }

    public OneMinus(SameDiff sameDiff, DifferentialFunction i_v, Object[] extraArgs) {
