...
public class All extends BaseTransformOp {
    ...
    public All(SameDiff sameDiff, DifferentialFunction i_v, boolean inPlace) {
        super(sameDiff, i_v, inPlace);
    }

    public All(SameDiff sameDiff, DifferentialFunction i_v, int[] shape, boolean inPlace, Object[] extraArgs) {
        super(sameDiff, i_v, shape, inPlace, extraArgs);
    }

    public All(SameDiff sameDiff, DifferentialFunction i_v, Object[] extraArgs) {
