...
public final class FlatResult extends Table {
  ...
  public FlatVariable variables(FlatVariable obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public FlatTiming timing(FlatTiming obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int timingLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  ...
  public static void addTiming(FlatBufferBuilder builder, int timingOffset) { builder.addOffset(4, timingOffset, 0); }
